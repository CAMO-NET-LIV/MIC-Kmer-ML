...
class DataSetLoader:
    def __init__(self, label_file, data_dir, transition_data_dir=None):
        ...
        self.data_files = list(self.label_lookup.keys())
    ...
    def prepare_dataset(self, test_size=0.2, random_state=38, remove_columns_target_percentile=0, random_transform_target_dim=0):
        X, y = self.load_data()
